...
# import json
# import os
# from server.service.mongo_db.constatnts import URI, DB_NAME, USERS_COLLECTION_NAME, MONGO_PASSWORD
# import pymongo
#
#
# #from server.service.mongo_db.db_entities import Project, User
#
...
#
#
# result = save_user(User(email="noam@gmail.com", password='123'))
